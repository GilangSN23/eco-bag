...
const Skeleton = () => (
  <div className="h-24 w-full rounded-xl bg-gradient-to-br from-neutral-200 to-neutral-100 dark:from-neutral-900 dark:to-neutral-800" />
);
    ...
    <BentoGrid className="max-w-7xl">
      {items.map((item, i) => (
        <BentoGridItem
          ...
          icon={item.icon}
          className={
            // Biar layout sesuai keinginan: item ke-3 besar
            i === 2 ? "lg:col-span-2" : undefined
          }
        />
      ))}
    </BentoGrid>
